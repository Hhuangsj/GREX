...
from ..systems.chignolin import ChignolinC22Implicit,chignolin_gmx

__all__ = ["ChignolinOBC2PT","Chignolin_gmx"]

class Chignolin_gmx(DataSet):
    """
    5us cMD gromacs
    """
    num_frames = 250001
    ...
    def __init__(self, root=os.getcwd(), download: bool = False, read: bool = False):
        ...
        self._system = chignolin_gmx()
        self._temperature = 300

    def read(self, n_frames=None, stride=None, atom_indices=None):
        self._xyz = np.load("/home/hsj/workstation/hsj_bgflow/experiment/chignolin.npy")
