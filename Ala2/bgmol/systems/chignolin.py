...
import mdtraj as md
__all__ = ["ChignolinC22Implicit","chignolin_gmx"]

###by hsj
class chignolin_gmx(OpenMMSystem):
    """
    ...
    def __init__(
        ...
        super(chignolin_gmx, self).__init__()
        ...
        with fixed_atom_names(TYR=["HT1", "HT2", "HT3"]):
            crds = app.PDBFile(os.path.join("/home/hsj/workstation/hsj_bgflow/experiment/MD_results/1uao/1uao.pdb"))

        # Load gmx files
        self._gro = app.GromacsGroFile('/home/hsj/workstation/hsj_bgflow/experiment/MD_results/1uao/nowater/md_nowat.gro')
        self._top = app.GromacsTopFile('/home/hsj/workstation/hsj_bgflow/experiment/MD_results/1uao/nowater/topol.top', 
                                       periodicBoxVectors=self._gro.getPeriodicBoxVectors(),
                                       includeDir='/home/hsj/software/gromacs/2022-plumed/share/gromacs/top')
        self._mdtraj_topology = md.load('/home/hsj/workstation/hsj_bgflow/experiment/MD_results/1uao/nowater/md_nowat.gro')

        # create system
        self._system = self._top.createSystem(nonbondedMethod=app.PME, nonbondedCutoff=1*unit.nanometer,constraints=app.HBonds)
        self._positions = crds.getPositions(asNumpy=True).value_in_unit(unit.nanometer)
        self._topology = app.getTopology()
