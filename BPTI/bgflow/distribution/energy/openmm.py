...
class OpenMMBridge(_Bridge):
    ...
    platform_properties : dict, optional
        Platform-specific OpenMM context properties, e.g. CUDA DeviceIndex or Precision.
    ...
    def __init__(
        ...
        platform_properties = {} if platform_properties is None else dict(platform_properties)
        cpu_properties = {'Threads': str(max(1, mp.cpu_count()//n_workers))} if platform_name == "CPU" else {}
        platform_properties = {**platform_properties, **cpu_properties}
